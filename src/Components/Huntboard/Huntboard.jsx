    ...
    return (
      <div>
        ...
        {this.props.hunts.map((hunt) => {
          return (
            <div key={hunt.id}>
              <img src={hunt.person.image_url} alt="fugitive" />
              <p>
                Defendant: {hunt.person.last_name}, {hunt.person.first_name}
              </p>
              ...
              <p>
                DoB: {moment(hunt.person.dob).format("MMM DD, YYYY")} Age:{" "}
                {moment(hunt.person.dob).toNow(true)}
              </p>
